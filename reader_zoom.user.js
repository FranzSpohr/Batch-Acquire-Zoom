...
// @version      11.13.19
// @description  For Slate Reader. Opens a page with a higher DPI render of document. Needs latest stable Chrome and Tampermonkey extension.
...
function hideElements() {
  document.getElementById('dotContainerUMich').style.opacity = '.75';
  document.getElementById('studentUMich').style.opacity = '.75';
  pageNumber.style.opacity = '.75';
  clearTimeout(timeoutHandle);
  timeoutHandle = setTimeout(function() {
    if (document.getElementById('dotContainerUMich') == null);
    document.getElementById('dotContainerUMich').style.opacity = '1';
    document.getElementById('studentUMich').style.opacity = '1';
